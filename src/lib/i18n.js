...
const messages = {
  ja: {
    ...
    'giveaway.leave.not_active': '### エラー\nこのギブアウェイは既に終了しています。',
    'giveaway.leave.not_entered': '### エラー\nこのギブアウェイに参加していません。',
    'giveaway.participants.not_found': '### エラー\nギブアウェイが見つかりませんでした。',
    'giveaway.participants.host_only': '### エラー\n参加者一覧はホストのみが閲覧できます。',
    ...
    'mod.error_not_a_member': '### エラー\n対象のユーザーは現在このサーバーのメンバーではないため、Kickできません。',
  ...
  en: {
    ...
    'giveaway.leave.not_active': '### Error\nThis giveaway has already ended.',
    'giveaway.leave.not_entered': '### Error\nYou are not entered in this giveaway.',
    'giveaway.participants.not_found': '### Error\nGiveaway not found.',
    'giveaway.participants.host_only': '### Error\nOnly the host can view participants.',
    ...
    'mod.error_not_a_member': '### Error\nThat user is not currently a member of this server, so they cannot be kicked.',
